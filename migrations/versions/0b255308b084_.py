...
Revision ID: 0b255308b084
Revises: 
Create Date: 2023-11-17 10:33:47.622024
...
def upgrade():
    ...
    op.create_table('Card_log',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('visitor_name', sa.String(length=30), nullable=False),
    sa.Column('department', sa.String(length=30), nullable=False),
    sa.Column('manager', sa.String(length=30), nullable=False),
    sa.Column('exited_date', sa.DateTime(), nullable=True),
    sa.Column('formatted_date', sa.DateTime(), nullable=True),
    sa.Column('card_type', sa.String(length=50), nullable=True),
    sa.Column('card_num', sa.String(length=50), nullable=True),
    ...
    sa.Column('device_date', sa.String(length=50), nullable=True),
    sa.Column('device_company', sa.String(length=50), nullable=True),
    sa.Column('device_department', sa.String(length=50), nullable=True),
    sa.Column('device_request_manager', sa.String(length=50), nullable=True),
    sa.Column('device_manager', sa.String(length=50), nullable=True),
    sa.Column('device_reason', sa.String(length=50), nullable=True),
    sa.Column('device_remarks', sa.String(length=50), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('approval_team', sa.String(length=50), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('arrival_departure', sa.String(length=255), nullable=True),
    sa.Column('purpose', sa.String(length=255), nullable=True),
    sa.Column('location', sa.String(length=255), nullable=True),
    sa.Column('customer_info', sa.String(length=255), nullable=True),
    ...
    with op.batch_alter_table('SMS_MSG_LOG_202311', schema=None) as batch_op:
        batch_op.drop_index('IDX_SMS_MSG_LOG_202311_1')
        batch_op.drop_index('IDX_SMS_MSG_LOG_202311_2')

    op.drop_table('SMS_MSG_LOG_202311')
    ...
    with op.batch_alter_table('MMS_MSG_LOG_202311', schema=None) as batch_op:
        batch_op.drop_index('IDX_MMS_MSG_LOG_202311_1')
        batch_op.drop_index('IDX_MMS_MSG_LOG_202311_2')

    op.drop_table('MMS_MSG_LOG_202311')
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('MMS_MSG_LOG_202311',
    ...
    with op.batch_alter_table('MMS_MSG_LOG_202311', schema=None) as batch_op:
        batch_op.create_index('IDX_MMS_MSG_LOG_202311_2', ['PHONE'], unique=False)
        batch_op.create_index('IDX_MMS_MSG_LOG_202311_1', ['STATUS', 'REQDATE'], unique=False)
    ...
    op.create_table('SMS_MSG_LOG_202311',
    sa.Column('MSGKEY', mysql.BIGINT(display_width=20), autoincrement=False, nullable=False),
    sa.Column('REQDATE', mysql.DATETIME(), nullable=False),
    sa.Column('SERIALNUM', mysql.INTEGER(display_width=11), autoincrement=False, nullable=True),
    sa.Column('ID', mysql.VARCHAR(length=16), nullable=True),
    ...
    with op.batch_alter_table('SMS_MSG_LOG_202311', schema=None) as batch_op:
        batch_op.create_index('IDX_SMS_MSG_LOG_202311_2', ['PHONE'], unique=False)
        batch_op.create_index('IDX_SMS_MSG_LOG_202311_1', ['STATUS', 'REQDATE'], unique=False)
